...
- Built REST APIs for **multilingual produce listings** supporting regional languages
- Implemented **verified buyer lead generation** with identity verification and credit-gated access
- Designed real-time **market reference pricing APIs** for live price discovery
- Developed **SMS/OTP-based login** for mobile-first, low-literacy rural users
- **Tech:** Java, Spring Boot, MySQL, REST APIs, Spring Security, Spring Data JPA, OTP Integration
